...
import { useRectangleSelectingState } from 'src/composables/modeStates/appCanvas/editMode/rectangleSelectingState'
import { useModeStateMachine } from '/@/composables/modeStates/core'
import { getBone } from '/@/models'

describe('src/composables/modeStates/appCanvas/editMode/rectangleSelectingState.ts', () => {
