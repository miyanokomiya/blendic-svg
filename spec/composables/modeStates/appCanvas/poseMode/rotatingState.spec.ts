...
import { useRotatingState } from 'src/composables/modeStates/appCanvas/poseMode/rotatingState'
import { useModeStateMachine } from '/@/composables/modeStates/core'
import { getBone } from '/@/models'

describe('src/composables/modeStates/appCanvas/poseMode/rotatingState.ts', () => {
  ...
  describe('onStart', () => {
    it('should execute "startEditMovement"', async () => {
      ...
      expect(ctx.setEditTransforms).toHaveBeenNthCalledWith(1, {}, 'rotate')
    })
  })
