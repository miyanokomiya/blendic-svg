...
import { useScalingState } from 'src/composables/modeStates/appCanvas/poseMode/scalingState'
import { useModeStateMachine } from '/@/composables/modeStates/core'
import { getBone } from '/@/models'

describe('src/composables/modeStates/appCanvas/poseMode/scalingState.ts', () => {
