...
import { GraphNodeLessThanOrEqual, GRAPH_VALUE_TYPE } from '/@/models/graphNode'
import { createBaseNode, NodeStruct } from '/@/utils/graphNodes/core'

export const struct: NodeStruct<GraphNodeLessThanOrEqual> = {
  create(arg = {}) {
    return {
      ...createBaseNode({
